...
public class LoginUI extends javax.swing.JFrame {
    ...
    private void LogInButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LogInButtonMouseClicked
        ...
        if (StudentRadioButton.isSelected()) {
            flag = LibObj.authenticate(id, password, "STUDENT");


        } else if (AdminRadioButton.isSelected()) {

            flag = LibObj.authenticate(id, password, "ADMIN");
        }
        ...
        } else if (flag == true && AdminRadioButton.isSelected()) {
            java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    new AdminMenuUI(id, LibObj).setVisible(true);
                }
            });
        } else {
            javax.swing.JOptionPane.showMessageDialog(this, "UserID or Password is wrong",
                    "Wrong Details entered", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
